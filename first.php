...
<form method="post" action="connec.php" >
   ...
   <li><input id="ab" class="a3" type="password" name="passw" placeholder="PASSWORD" required maxlength="10" minlength="7"></li>
   <li><input id="ab" class="a4" type="password" name="" placeholder="CONFIRM PASSWORD" required maxlength="10" minlength="7"></li>
...
<div id="log">
 <form method="post" action="">
 	<ol>
 		...
 		<li><input id="ac" class="b5" type="password" name="password" placeholder="PASSWORD" required=""></li>
 	</ol>
