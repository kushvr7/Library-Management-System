 ...
 //if( isset($_POST['table'])  )
   // {
    ...
    if(@mysqli_num_rows($connStatusa)>0){
		echo ' <p style="position:absolute;top:-16px;left:580px;font-size:30px;font-weight:bold;">BOOK REQUEST</p> ';
        echo '<table style="border :2px solid black; position:absolute;top:60px;left:484px;">';
            echo '<tr style="border :2px solid black">';
                ...
                echo "<th style='border :2px solid brown;padding:10px;'>PUBLICATION</th>";
            echo "</tr>";
        while($row = @mysqli_fetch_array($connStatusa)){
            echo "<tr style='border :2px solid black'>";
                ...
                echo "<td style='padding:10px;'>" . $row['PUBLICATIONS'] . "</td>";
            echo "</tr>";
        }
        echo "</table>";
